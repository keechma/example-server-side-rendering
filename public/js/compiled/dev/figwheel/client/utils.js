...
return (new CustomEvent(event_name,(function (){var obj34371 = {"detail":data};
return obj34371;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25217__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25217__auto__)){
var and__25217__auto____$1 = (window["CustomEvent"]);
...
var args34376 = [];
var len__26342__auto___34382 = arguments.length;
var i__26343__auto___34383 = (0);
while(true){
if((i__26343__auto___34383 < len__26342__auto___34382)){
args34376.push((arguments[i__26343__auto___34383]));

var G__34384 = (i__26343__auto___34383 + (1));
i__26343__auto___34383 = G__34384;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args34376.length)].join('')));
...
var f = (function (){var pred__34379 = cljs.core._EQ_;
var expr__34380 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34379.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34380))){
return ((function (pred__34379,expr__34380){
return (function (p1__34372_SHARP_){
return console.warn(p1__34372_SHARP_);
});
;})(pred__34379,expr__34380))
} else {
if(cljs.core.truth_(pred__34379.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34380))){
return ((function (pred__34379,expr__34380){
return (function (p1__34373_SHARP_){
return console.debug(p1__34373_SHARP_);
});
;})(pred__34379,expr__34380))
} else {
if(cljs.core.truth_(pred__34379.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34380))){
return ((function (pred__34379,expr__34380){
return (function (p1__34374_SHARP_){
return console.error(p1__34374_SHARP_);
});
;})(pred__34379,expr__34380))
} else {
return ((function (pred__34379,expr__34380){
return (function (p1__34375_SHARP_){
return console.log(p1__34375_SHARP_);
});
;})(pred__34379,expr__34380))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34386){
var map__34389 = p__34386;
var map__34389__$1 = ((((!((map__34389 == null)))?((((map__34389.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34389.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34389):map__34389);
var opts = map__34389__$1;
var eval_fn = cljs.core.get.call(null,map__34389__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34391_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34393,(0),null);
...
var args34396 = [];
var len__26342__auto___34399 = arguments.length;
var i__26343__auto___34400 = (0);
while(true){
if((i__26343__auto___34400 < len__26342__auto___34399)){
args34396.push((arguments[i__26343__auto___34400]));

var G__34401 = (i__26343__auto___34400 + (1));
i__26343__auto___34400 = G__34401;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args34396.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25217__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1488028161365