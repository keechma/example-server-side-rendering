...
var args33446 = [];
var len__26342__auto___33450 = arguments.length;
var i__26343__auto___33451 = (0);
while(true){
if((i__26343__auto___33451 < len__26342__auto___33450)){
args33446.push((arguments[i__26343__auto___33451]));

var G__33452 = (i__26343__auto___33451 + (1));
i__26343__auto___33451 = G__33452;
continue;
} else {
}
break;
...
var G__33449 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33449,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33449;
}
});
...
var or__25229__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__26342__auto___33457 = arguments.length;
var i__26343__auto___33458 = (0);
while(true){
if((i__26343__auto___33458 < len__26342__auto___33457)){
args__26349__auto__.push((arguments[i__26343__auto___33458]));

var G__33459 = (i__26343__auto___33458 + (1));
i__26343__auto___33458 = G__33459;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26350__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33454){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33455,G__33456,seq33454__$2);
});
...
var file = cljs.core.get.call(null,map__33463__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33463__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33463__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33463,map__33463__$1,file,line,column){
return (function (p1__33460_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33460_SHARP_));
});})(map__33463,map__33463__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__26162__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__26162__auto__,prefer_table__26163__auto__,method_cache__26164__auto__,cached_hierarchy__26165__auto__,hierarchy__26166__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__25229__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__25229__auto__)){
return or__25229__auto__;
} else {
...
var temp__4657__auto___33465 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33465)){
var message_33466 = temp__4657__auto___33465;
cljs.core.println.call(null,message_33466);
} else {
}
...
var temp__4657__auto___33467 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33467)){
var message_33468 = temp__4657__auto___33467;
cljs.core.println.call(null,message_33468);
} else {
}
...
var temp__4655__auto__ = (function (){var and__25217__auto__ = typeof exception.stack === 'string';
if(and__25217__auto__){
var G__33478 = exception.stack;
var G__33478__$1 = (((G__33478 == null))?null:clojure.string.split_lines.call(null,G__33478));
var G__33478__$2 = (((G__33478__$1 == null))?null:cljs.core.get.call(null,G__33478__$1,depth));
if((G__33478__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33478__$2);
}
} else {
...
var vec__33479 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33479,(0),null);
var column = cljs.core.nth.call(null,vec__33479,(1),null);
var vec__33482 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33482,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33482,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33482,(2),null);
...
var m__$1 = (function (){var G__33486 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__33486) {
case "fail":
...
var G__33492 = (function (){var G__33491 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33491);
} else {
return G__33491;
}
})();
...
return cljs.core.vary_meta.call(null,G__33494,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e33497){var e = e33497;
var G__33498 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__33498) {
...
var vec__33503 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33503,(0),null);
var types = vec__33503;
...
var ns = cljs.core.nth.call(null,vec__33516,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33516,(1),null);
return ((function (vec__33516,ns,vars__$1){
return (function (){
...
var G__33519 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__33519) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1){
return (function (){
var seq__33520 = cljs.core.seq.call(null,vars__$1);
var chunk__33521 = null;
var count__33522 = (0);
var i__33523 = (0);
while(true){
if((i__33523 < count__33522)){
var v = cljs.core._nth.call(null,chunk__33521,i__33523);
var temp__4657__auto___33525 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33525)){
var t_33526 = temp__4657__auto___33525;
each_fixture_fn.call(null,((function (seq__33520,chunk__33521,count__33522,i__33523,t_33526,temp__4657__auto___33525,v,each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33526)));
});})(seq__33520,chunk__33521,count__33522,i__33523,t_33526,temp__4657__auto___33525,v,each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1))
);
} else {
}

var G__33527 = seq__33520;
var G__33528 = chunk__33521;
var G__33529 = count__33522;
var G__33530 = (i__33523 + (1));
seq__33520 = G__33527;
chunk__33521 = G__33528;
count__33522 = G__33529;
i__33523 = G__33530;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__33520);
if(temp__4657__auto__){
var seq__33520__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33520__$1)){
var c__26048__auto__ = cljs.core.chunk_first.call(null,seq__33520__$1);
var G__33531 = cljs.core.chunk_rest.call(null,seq__33520__$1);
var G__33532 = c__26048__auto__;
var G__33533 = cljs.core.count.call(null,c__26048__auto__);
var G__33534 = (0);
seq__33520 = G__33531;
chunk__33521 = G__33532;
count__33522 = G__33533;
i__33523 = G__33534;
continue;
} else {
var v = cljs.core.first.call(null,seq__33520__$1);
var temp__4657__auto___33535__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33535__$1)){
var t_33536 = temp__4657__auto___33535__$1;
each_fixture_fn.call(null,((function (seq__33520,chunk__33521,count__33522,i__33523,t_33536,temp__4657__auto___33535__$1,v,seq__33520__$1,temp__4657__auto__,each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33536)));
});})(seq__33520,chunk__33521,count__33522,i__33523,t_33536,temp__4657__auto___33535__$1,v,seq__33520__$1,temp__4657__auto__,each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1))
);
} else {
}

var G__33537 = cljs.core.next.call(null,seq__33520__$1);
var G__33538 = null;
var G__33539 = (0);
var G__33540 = (0);
seq__33520 = G__33537;
chunk__33521 = G__33538;
count__33522 = G__33539;
i__33523 = G__33540;
continue;
}
} else {
...
});})(each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1))
);
});})(each_fixture_fn,G__33519,env,once_fixtures,each_fixtures,vec__33516,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1488028101869