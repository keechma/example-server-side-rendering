...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25840__auto__,writer__25841__auto__,opt__25842__auto__){
return cljs.core._write.call(null,writer__25841__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28925 = o;
(G__28925[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__28926__delegate = function (args){
...
while (G__28927__i < G__28927__a.length) {G__28927__a[G__28927__i] = arguments[G__28927__i + 0]; ++G__28927__i;}
  args = new cljs.core.IndexedSeq(G__28927__a,0);
} 
...
if(cljs.core.truth_((function (){var and__25217__auto__ = !((jsprops == null));
if(and__25217__auto__){
var and__25217__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28934 = jsprops;
(G__28934["defaultValue"] = value);

(G__28934["onChange"] = ((function (G__28934,v,value,on_change){
return (function (p1__28931_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28931_SHARP_);
});})(G__28934,v,value,on_change))
);

(G__28934["ref"] = ((function (G__28934,v,value,on_change){
return (function (p1__28932_SHARP_){
return (this$["cljsInputElement"] = p1__28932_SHARP_);
});})(G__28934,v,value,on_change))
);
...
var vec__28941 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28941,(0),null);
var id = cljs.core.nth.call(null,vec__28941,(1),null);
var class$ = cljs.core.nth.call(null,vec__28941,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28946 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___28946 == null)){
} else {
var key_28947 = temp__4661__auto___28946;
(jsprops["key"] = key_28947);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28949 = (new reagent.impl.template.NativeWrapper());
(G__28949["name"] = c);
...
var len__26342__auto___28955 = arguments.length;
var i__26343__auto___28956 = (0);
while(true){
if((i__26343__auto___28956 < len__26342__auto___28955)){
args__26349__auto__.push((arguments[i__26343__auto___28956]));

var G__28957 = (i__26343__auto___28956 + (1));
i__26343__auto___28956 = G__28957;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26350__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28953){
var G__28954 = cljs.core.first.call(null,seq28953);
var seq28953__$1 = cljs.core.next.call(null,seq28953);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28954,seq28953__$1);
});
...
break;
default:
var G__28961 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28961;
continue;
...
var n__26152__auto___28964 = a.length;
var i_28965 = (0);
while(true){
if((i_28965 < n__26152__auto___28964)){
(a[i_28965] = reagent.impl.template.as_element.call(null,(a[i_28965])));

var G__28966 = (i_28965 + (1));
i_28965 = G__28966;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26152__auto___28967 = a.length;
var i_28968 = (0);
while(true){
if((i_28968 < n__26152__auto___28967)){
var val_28969 = (a[i_28968]);
if((cljs.core.vector_QMARK_.call(null,val_28969)) && ((reagent.impl.template.key_from_vec.call(null,val_28969) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28968] = reagent.impl.template.as_element.call(null,val_28969));

var G__28970 = (i_28968 + (1));
i_28968 = G__28970;
continue;
} else {
}
...
var ctx = ({});
var vec__28974 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28974,(0),null);
var derefed = cljs.core.nth.call(null,vec__28974,(1),null);
...
var G__28978 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28978) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28978){
...
//# sourceMappingURL=template.js.map?rel=1488028157707